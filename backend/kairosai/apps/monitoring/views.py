            ...
            'milestones': [
                {
                    ...
                    'is_completed': m.is_completed,
                    'estimated_cost': str(m.estimated_cost) if m.estimated_cost else None,
                    'actual_cost': str(m.actual_cost) if m.actual_cost else None,
                    'notes': m.notes,
                    'created_at': m.created_at.isoformat(),
                }
                for m in milestones
...
class MilestoneUpdateView(APIView):
    ...
    def patch(self, request, pk):
        ...
        return Response({
            ...
            'actual_cost': str(milestone.actual_cost) if milestone.actual_cost else None,
...
class NewsFeedView(APIView):
    ...
    def get(self, request):
        ...
        news_items = [
            {
                ...
                'summary': 'Government officials have announced plans to streamline the registration process for foreign companies, potentially reducing setup time by 40%.',
                'category': 'regulatory',
            ...
            },
            {
                ...
                'summary': 'A leading industry player has revealed plans for significant investment in market expansion, signaling growing confidence in the region.',
                'category': 'competitor',
            ...
            },
            {
                ...
                'summary': 'Industry analysts project strong growth driven by digital transformation, increasing consumer spending, and favorable policy changes.',
                'category': 'economic',
                'source': 'Reuters',
            ...
            },
            {
                ...
                'summary': 'A bilateral trade agreement has been signed that reduces tariffs and simplifies compliance requirements for foreign businesses.',
            ...
            },
            {
                ...
                'summary': 'Rising middle-class incomes and increased digital adoption are driving unprecedented consumer spending in the region.',
                'category': 'economic',
                'source': 'Bloomberg',
        ...
        return Response({
            ...
            'note': 'Live news feed powered by AI will be available in a future update.',
