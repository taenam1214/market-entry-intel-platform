...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,market-entry-intel-platform-production.up.railway.app,healthcheck.railway.app').split(',')
...
#         'NAME': config('DB_NAME', default='market_intelligence'),
